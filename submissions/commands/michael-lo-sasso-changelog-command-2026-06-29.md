...
Turn source material (PR links/numbers, a commit range, a diff, a branch/PR list, or a release-notes draft) into a self-contained HTML changelog, drafted then graded against a quality rubric (never auto-publishes).
